...
results = recommendation_collaborative(
    ...
    alpha=st.session_state.lambda_param
)

if results is None or results.empty:
    st.warning("No recommendations found — cold start or no saved shows.")
else:
    display_recommendations(results, st.session_state.user_id)